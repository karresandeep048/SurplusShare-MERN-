                ...
                <div className="mb-8 p-6 bg-gradient-to-r from-amber-500 to-emerald-600 text-white rounded-3xl shadow-xl animate-fade-in">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            <Link 
                                to={`/track-order/${arrivedPickers[0].pickupCode}`}
                                className="bg-white/20 hover:bg-white/30 text-white px-4 py-2.5 rounded-xl font-bold text-xs backdrop-blur-md transition flex items-center gap-1.5"
                            >
                            ...
                            <a 
                                href="#verify-section" 
                                className="bg-white text-emerald-800 hover:bg-emerald-50 px-5 py-2.5 rounded-xl font-black text-xs shadow-md transition-all"
                            >
                                Verify 6-Digit Code ↓
                            </a>
                        </div>
                                            ...
                                            {res.status === 'COLLECTED' ? (
                                                ...
                                                <>
                                                    <Link 
                                                        ...
                                                        className="px-2.5 py-1 bg-brand-50 hover:bg-brand-100 text-brand-700 rounded-lg text-[11px] font-bold inline-flex items-center gap-1 transition"
                                                        title="Track receiver live location"
                                                    >
